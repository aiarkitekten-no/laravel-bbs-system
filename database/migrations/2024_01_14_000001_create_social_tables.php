...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('logoff_quotes')) {
        ...
        if (!Schema::hasTable('user_club_members')) {
        ...
        if (!Schema::hasTable('graffiti_wall')) {
